...
- **Expiración del Enlace:** 1 hora de validez (configurado en Supabase).
- **Estado Post-Reset:** Redirección a la página de `/login` para ingreso manual con la nueva clave.
- **Confirmación de Solicitud:** Mensaje informativo que confirma el envío al email del usuario.
