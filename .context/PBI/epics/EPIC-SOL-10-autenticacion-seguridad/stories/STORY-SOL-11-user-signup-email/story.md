...
- **Verificación de Email:** NO requerida para el MVP. Acceso directo tras registro.
- **Fortaleza de Contraseña:** Mínimo 6 caracteres.
- **Flujo Exitoso:** Auto-login automático y redirección a `/dashboard`.
