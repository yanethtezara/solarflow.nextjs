# Como David, quiero poder pre-definir un catálogo de mis servicios de mano de obra con sus precios para poder agregarlos rápidamente a los trabajos.
...
**So that** poder agregarlos rápidamente a los trabajos
...
### Scenario: Utilizar un servicio pre-definido en un trabajo (funcionalidad futura, solo visibilidad)

-   **Given:** David está creando o editando un trabajo
...
-   STORY-SOL-TBD - Asociar materiales y mano de obra a un trabajo.
