...
Esta épica se encarga de la gestión de un catálogo predefinido de servicios de mano de obra y materiales que los instaladores utilizan frecuentemente. El objetivo es agilizar la asignación de costos y recursos a cada instalación de instalación.

**Business Value:**
Permite a los usuarios estandarizar sus precios y costos, reducir el tiempo dedicado a la introducción de datos en cada instalación y asegurar una mayor precisión en el cálculo de presupuestos y facturas.

---

## User Stories

1. **SOL-19** - As a David, I want to poder pre-definir un catálogo de mis servicios de mano de obra con sus precios para poder agregarlos rápidamente a los instalaciones.
...
- EPIC-SOLAR-003: Gestión de Instalaciones de Instalación (Core) (los instalaciones asignarán materiales/servicios del catálogo).
...
- Reducción del 20% en el tiempo de creación de un instalación al usar ítems de catálogo.
