...
Esta épica se centra en la funcionalidad de generar facturas de manera sencilla a partir de los trabajos completados. Permite visualizar, personalizar con el logo del negocio y descargar la factura en formato PDF.
...
1. **SOL-33** - As a Javi, I want to poder generar una vista de factura para un trabajo "Completado" con un solo clic, que calcule automáticamente el total sumando la mano de obra y los materiales.
...
-   Generación de una vista previa de factura para trabajos con estado "Completado".
-   Cálculo automático del total basado en los ítems asociados al trabajo.
...
1. ✅ Un usuario puede generar una factura para cualquier trabajo completado.
...
-   Utiliza las tablas `trabajos`, `trabajos_items`, `catalogo_items`, `clientes`, `empresas`.
...
-   Asegurar que solo el propietario de un trabajo puede generar su factura.
...
-   EPIC-SOL-22: Gestión de Trabajos de Instalación (Core) (especialmente la US de "Completar trabajo" y "Agregar ítems").
...
-   Tasa de Generación de Facturas > 70% (trabajos marcados como "Completado" tienen una factura generada).
...
La vista de factura debe ser un "read-only" del trabajo y sus ítems en el momento de la generación, para evitar inconsistencias si el trabajo se edita después.
