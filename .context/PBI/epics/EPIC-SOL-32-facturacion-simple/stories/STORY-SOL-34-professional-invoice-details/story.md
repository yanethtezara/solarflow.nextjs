...
-   **Given:** David genera una factura para un trabajo asociado al "Cliente X"
...
-   **Given:** David genera una factura para un trabajo con varios ítems asociados
-   **When:** visualiza la factura
...
-   Los datos del cliente se obtienen del cliente asociado al trabajo.
