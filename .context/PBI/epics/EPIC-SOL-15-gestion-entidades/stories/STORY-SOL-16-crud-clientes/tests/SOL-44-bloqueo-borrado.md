# SOL-44: Validar bloqueo de borrado de cliente con trabajos asociados
...
Scenario Outline: Validar bloqueo de borrado de cliente con trabajos asociados
Given existe un cliente con {cliente_id} creado por el usuario activo
And existe al menos un trabajo con {trabajo_id} asociado al {cliente_id}
