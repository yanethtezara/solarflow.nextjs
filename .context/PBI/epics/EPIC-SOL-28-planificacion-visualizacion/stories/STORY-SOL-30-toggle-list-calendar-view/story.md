...
-   La vista de lista reutiliza el componente de la lista de trabajos existente.
...
-   **Given:** Javi está en la sección "Mis Trabajos" en la vista de lista
-   **When:** hace clic en el botón o selector "Vista Calendario"
-   **Then:** la visualización de los trabajos cambia a la vista de calendario (mensual)
-   **And:** los trabajos se muestran correctamente en el calendario
...
-   **Then:** la visualización de los trabajos cambia a la vista de lista
-   **And:** los trabajos se muestran correctamente en la lista con sus detalles
