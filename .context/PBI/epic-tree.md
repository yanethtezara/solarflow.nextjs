...
Project Code: SOL
Jira Project: (URL del proyecto en Jira, una vez conocido)

---

## Epic Hierarchy

### EPIC 1: Autenticación y Seguridad de Cuenta

**Planned Jira Key:** SOL-TBD
**Priority:** CRITICAL
**Description:** Funcionalidades para registro, login, logout y recuperación de contraseña.
...
### EPIC 2: Gestión de Entidades (Clientes y Empresas)

**Planned Jira Key:** SOL-TBD
**Priority:** HIGH
**Description:** Funcionalidades para la gestión (CRUD) de clientes y empresas contratantes.
...
### EPIC 4: Planificación y Visualización
...
### EPIC 5: Catálogo de Servicios y Materiales
...
1. SOL-TBD - As a David, I want to poder pre-definir un catálogo de mis servicios de mano de obra con sus precios.
2. SOL-TBD - As a Javi, I want to poder pre-definir un catálogo de los materiales más comunes que uso con sus costos.
3. SOL-TBD - As a Javi, I want to que los catálogos sean editables (CRUD).

---

### EPIC 6: Facturación Simple
...
1. EPIC 1 - Autenticación y Seguridad de Cuenta
2. EPIC 2 - Gestión de Entidades (Clientes y Empresas)
3. EPIC 5 - Catálogo de Servicios y Materiales
