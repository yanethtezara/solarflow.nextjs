...
const MESSAGES: Record<string, string> = {
  ...
  trabajo_creado: 'Instalación creada correctamente.',
  trabajo_actualizado: 'Instalación actualizada correctamente.',
  trabajo_eliminado: 'Instalación eliminada correctamente.',
};
